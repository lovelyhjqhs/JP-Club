...
- 卡片标题统一为「年级 + 班号 + 游园会」（如「高一四班游园会」），右上角只显示班号；卡片内显示活动主题、看点与活动标签，海报按 3:4 比例裁切并懒加载
- 支持按年级筛选，以及按班级编号、班级名、主题、玩法或关键词实时搜索
- 支持益智/推理、桌游、剧本杀、手工、人文/文学、学科、音乐、合作/互动 八类标签筛选（筛选按钮由 `YYH_TAGS` 自动生成）
- 2511 与 2512 互为联动班级，卡片与详情弹窗中都提供互指链接，点击可直接跳到对方班级
...
- 班级互指链接配置在 `CLASS_LINKS` 对象中（双向成对填写），卡片与弹窗会据此生成「↔ 与某某班联动」的跳转。
