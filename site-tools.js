(function () {
  ...
  var dict = {
    ...
    "yyh.g25": ["25级（高二）", "Class of 2025 (Grade 11)"],
    "yyh.g26": ["26级（高一）", "Class of 2026 (Grade 10)"],
    "yyh.search": ["搜索班级、主题、玩法或海报文字...", "Search class, theme, activity or poster text..."],
    "yyh.allTags": ["全部玩法", "All types"],
